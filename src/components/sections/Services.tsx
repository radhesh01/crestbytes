...
const SERVICES_DATA: ServiceItem[] = [
  {
    ...
    keywords: ['Art Direction', 'Typography', 'Responsive Layout', 'Motion Systems'],
    href: '/services',
  },
  {
    id: 'web-development',
    ...
    keywords: ['Next.js App Router', 'TypeScript', 'Clean Code', 'API Integration'],
    href: '/services',
  },
  {
    id: 'ecommerce',
    ...
    keywords: ['Custom Storefronts', 'Shopify Architecture', 'Checkout Funnels', 'Catalog Systems'],
    href: '/services',
  },
  {
    id: 'web-apps',
    ...
    keywords: ['Client Portals', 'SaaS Dashboards', 'Workflow Automation', 'State Architecture'],
    href: '/services',
  },
  {
    id: 'strategy',
    ...
    keywords: ['Brand Architecture', 'Positioning', 'Content Hierarchy', 'Competitor Audits'],
    href: '/services',
  },
  {
    id: 'performance',
    ...
    description: 'Auditing, refactoring, and optimizing existing web infrastructure for Core Web Vitals, fast page loads, and superior SEO visibility.',
    keywords: ['Core Web Vitals', 'Technical SEO', 'Asset Optimization', 'Edge Delivery'],
    href: '/services',
  },
]

function renderServiceBlueprintSVG(index: number) {
  switch (index) {
    case 0:
      return (
      ...
      return (
        <div className="services-blueprint">
          <svg viewBox="0 0 380 260" fill="none" className="services-blueprint__svg">
            ...
            <text x="78" y="206" fill="#ffffff" fontSize="10" fontFamily="monospace">TYPESCRIPT CHECK: PASSED // STATIC EXPORT READY</text>
          </svg>
        </div>
      )
    case 2:
      return (
        <div className="services-blueprint">
          <svg viewBox="0 0 380 260" fill="none" className="services-blueprint__svg">
            ...
            <text x="185" y="215" fill="var(--accent)" fontSize="10" fontFamily="monospace" textAnchor="middle">COMMERCE ARCHITECTURE: MODULAR</text>
          </svg>
        </div>
      )
    case 3:
      return (
        <div className="services-blueprint">
          <svg viewBox="0 0 380 260" fill="none" className="services-blueprint__svg">
            ...
            <text x="185" y="172" fill="rgba(255,255,255,0.5)" fontSize="8.5" fontFamily="monospace" textAnchor="middle">DATA FLOW</text>
            <text x="185" y="194" fill="#ffffff" fontSize="12" fontFamily="monospace" fontWeight="bold" textAnchor="middle">REALTIME</text>

            <rect x="245" y="150" width="90" height="65" rx="4" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" />
            <text x="290" y="172" fill="rgba(255,255,255,0.5)" fontSize="8.5" fontFamily="monospace" textAnchor="middle">STATE BUS</text>
            <text x="290" y="194" fill="var(--accent)" fontSize="12" fontFamily="monospace" fontWeight="bold" textAnchor="middle">SYNCED</text>
          </svg>
        </div>
      )
    case 4:
      ...
      return (
        <div className="services-blueprint">
          <svg viewBox="0 0 380 260" fill="none" className="services-blueprint__svg">
            ...
            <text x="115" y="118" fill="#ffffff" fontSize="13" fontFamily="monospace" fontWeight="bold" textAnchor="middle">CORE WEB</text>
            <text x="115" y="132" fill="var(--accent)" fontSize="10" fontFamily="monospace" textAnchor="middle">VITALS</text>

            <rect x="195" y="55" width="145" height="34" rx="4" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" />
            <text x="208" y="76" fill="rgba(255,255,255,0.7)" fontSize="9.5" fontFamily="monospace">LCP // PAINT</text>

            <rect x="195" y="98" width="145" height="34" rx="4" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" />
            <text x="208" y="119" fill="rgba(255,255,255,0.7)" fontSize="9.5" fontFamily="monospace">CLS // STABILITY</text>

            <rect x="195" y="141" width="145" height="34" rx="4" fill="rgba(255,255,255,0.03)" stroke="rgba(255,255,255,0.08)" />
            <text x="208" y="162" fill="var(--accent)" fontSize="9.5" fontFamily="monospace">SEO // STRUCTURE</text>

            <text x="190" y="210" fill="var(--accent)" fontSize="9" fontFamily="monospace" textAnchor="middle">ENGINEERED FOR DISCOVERABILITY & SPEED</text>
          </svg>
        </div>
      )
    default:
...
export default function Services() {
  ...
  const handleKeyDown = (e: React.KeyboardEvent, index: number) => {
    if (e.key === 'ArrowDown') {
      e.preventDefault()
      const next = (index + 1) % SERVICES_DATA.length
      setActiveService(next)
      document.getElementById(`service-tab-${next}`)?.focus()
    } else if (e.key === 'ArrowUp') {
      e.preventDefault()
      const prev = (index - 1 + SERVICES_DATA.length) % SERVICES_DATA.length
  ...
  return (
    <section className="services-section" id="services" aria-labelledby="services-heading">
      <div className="container services-section__container">
          ...
          >
            ...
            >
              ...
              <div className="services-preview-panel__stage">
                {renderServiceBlueprintSVG(activeService)}
              </div>
        ...
        {/* Mobile Accordion Experience with Inline SVG Blueprints */}
        <div className="services-section__mobile-layout hide-on-desktop">
          {SERVICES_DATA.map((service, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {/* Inline Blueprint Visual on Mobile */}
                  <div className="mobile-service-card__blueprint">
                    {renderServiceBlueprintSVG(index)}
                  </div>
